...
import Blur from "../assets/blur-1-in-hero-page.svg"
import BottomBlur from "../assets/blur-2-in-hero-page.svg";
  ...
  return (
    <div className='IndianStats'>
      ...
      <div className='IndianStatsTwoBoxAndScrollBox'>
        <img src={Blur} alt="" className='BlurEffectInIndianStats'/>
        <img src={BottomBlur} alt="" className='BlurEffectBottomInIndianStats'/>
